...
<?php endif; ?>
            ...
            <td class="f-14">
                <a href="#" onclick="layer_open('个人信息', '/admin/commodity/info/id/<?php echo $vo['id']; ?>.html')">购买详情</a>&nbsp;&nbsp;&nbsp;
