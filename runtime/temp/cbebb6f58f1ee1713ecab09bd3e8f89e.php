<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"E:\GitHub\licai./application/wap\view\order\vipgm.html";i:1513416431;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<head>
		...
		<style type="text/css">
			...
			.detail1,
			.big-button {
				background-image: url(__WAP__/img/vip.jpg);
			...
			.detail3 .row:nth-child(3) p {
				border: none;
			}

			.detail3 .row:nth-child(3) input {
				border: none;
				width: 7rem;
		...
		<div class="wrapper">
			...
			<div class="detail">
				...
				<div class="detail2">
					...
					<p><span>项目编号</span><span class="em">MER20170001176</span></p>
				...
				<div class="detail3">
					...
					<div class="row">
						...
						<p>
							...
							<input type="tel" name="" id="number" value="1" maxlength="5" />
							<span id="plus">+</span>
						</p>
					</div>
					...
					<div class="row">
						<p>VIP邀请码</p>
						<p style="border: none;">
							<input type="tel" name="" id="vip6" placeholder="请输入VIP邀请码" maxlength="6" />
						</p>
					</div>
					<div class="row">
						<p>支付密码</p>
					...
					<div class="row">
						...
						<p><span>共</span><span class="em" id="numbers">1</span><span>只羊:   </span><span class="em">￥</span><span class="em" id="qian">780.00</span>
							<span style="font-size: 0.6rem;margin-left: 2px;">（</span><span style=" font-size: 0.6rem;">养殖利润:</span><span class="em" style="font-size: 0.6rem;     color: #a9a9a9;">￥</span><span class="em" id="profit" style="font-size: 0.7rem;    color: #a9a9a9;">46.80</span><span class="em"></span><span style="font-size: 0.6rem;">）</span>
						</p>
					</div>
					<div class="row row6">
						<div>
			...
			<a href="#" class="found m_co sh_au-ex" style="display: none;">商铺辅助羊群说明</a>
		...
		/*羊数量超出 剩余 提升*/
			...
			$(".row6>div>div").click(function() {
				...
				if(r6s == 1) {
					...
					$("#big-button").css("background", " url(img/vip.jpg)");
					$("#big-button").css("background-size", "100% 100%");
...
/*买羊按钮点击*/
			$("#big-button").click(function() {
				...
				if($("#vip6").val() == "") {
					$(".overtop1 .overtop_text").text("请输入VIP邀请码");
				} else if($("#vip6").val().length == 6){
					...
					$(".overtop1 .overtop_text").text("您输入的VIP邀请码不正确");
