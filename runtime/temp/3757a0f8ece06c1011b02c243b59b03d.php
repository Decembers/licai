<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"D:\server\licai./application/admin\view\barner\edit.html";i:1513329670;s:58:"D:\server\licai./application/admin\view\template\base.html";i:1488899632;s:69:"D:\server\licai./application/admin\view\template\javascript_vars.html";i:1488899632;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" name="img" value="<?php echo isset($vo['image']) ? $vo['image'] :  ''; ?>" class="input-text" id="upload" placeholder="请点击后面的上传按钮" datatype="*" nullmsg="请填写图片url" style="width: 70%">
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3">url地址：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="url地址" name="url" value="<?php echo isset($vo['url']) ? $vo['url'] :  ''; ?>" >
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
