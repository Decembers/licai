<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"E:\GitHub\licai./application/wap\view\member\wdhy.html";i:1513913348;}*/ ?>
<!DOCTYPE html>
<html>
			...
			<ul>
				<li>
					<div class="fw_left fl">
						<div class="chtx a1">0</div>
						<div>好友人数</div>
					</div>
					<div class="fw_right fr">
						<div><span>有效推荐：</span><span>0人</span></div>
						<div><span>无效推荐：</span><span>0人</span></div>
					</div>
