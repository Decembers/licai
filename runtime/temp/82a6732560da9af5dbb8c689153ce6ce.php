<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"E:\GitHub\licai./application/wap\view\login\nopay.html";i:1513922376;}*/ ?>
<!DOCTYPE html>
<html>
					...
					<div class="modify_login fillet">
						<ul>
							...
							<li class="form_modify">
								...
								<input type="password" id="dl_user_pwd" name="dl_user_pwd" placeholder="请输入支付密码" maxlength="14">
							</li>
							<li class="form_modify">
								<span class="more"></span>
								<span class="delect"></span>
								<input type="password" id="dl_user_pwd_confirm" name="dl_user_pwd_confirm" placeholder="请再次输入支付密码" maxlength="14">
							</li>
						</ul>
					</div>
						...
						if($("#dl_user_pwd").val() == "") {
							...
							if($("#dl_user_pwd_confirm").val() == "") {
								...
								if($("#dl_user_pwd_confirm").val() == $("#dl_user_pwd").val()) {
											...
											$.ajax({
							                    type : "POST",  //提交方式
							                    url : "<?php echo url('Login/nopay'); ?>",//路径
							                    data : {
							                        "mobile" : mobile,
							                        "pay_pass" : password,
							                        "code" : code,
