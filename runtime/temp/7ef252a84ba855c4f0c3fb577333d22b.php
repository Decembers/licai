<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:61:"D:\server\licai./application/admin\view\order\recyclebin.html";i:1512804214;s:64:"D:\server\licai./application/admin\view\template\recyclebin.html";i:1512955060;s:58:"D:\server\licai./application/admin\view\template\base.html";i:1488899632;s:69:"D:\server\licai./application/admin\view\template\javascript_vars.html";i:1488899632;s:55:"D:\server\licai./application/admin\view\order\form.html";i:1512983049;s:53:"D:\server\licai./application/admin\view\order\th.html";i:1512984761;s:53:"D:\server\licai./application/admin\view\order\td.html";i:1512985294;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <input type="text" class="input-text" style="width:250px" placeholder="订单id" name="id" value="<?php echo \think\Request::instance()->param('id'); ?>" >
    <input type="text" class="input-text" style="width:250px" placeholder="订单编号" name="number" value="<?php echo \think\Request::instance()->param('number'); ?>" >
...
<td><?php echo $vo['sp_price']; ?></td>
<td><?php echo $vo['sp_count']; ?></td>
<td>
<?php if($vo['sfpay'] == 0): ?>
<p style="color:#EE2C2C">未支付</p>
<?php elseif($vo['sfpay'] == 1): ?>
<p style="color:#66CDAA">已支付</p>
<?php elseif($vo['sfpay'] == 2): ?>
<p style="color:#4876FF">已退款</p>
<?php endif; ?>
</td>
            <td class="f-14">
