<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"D:\server\licai./application/admin\view\commodity\edit.html";i:1513137463;s:58:"D:\server\licai./application/admin\view\template\base.html";i:1488899632;s:69:"D:\server\licai./application/admin\view\template\javascript_vars.html";i:1488899632;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6 skin-minimal">
                <div class="radio-box">
                    <?php if($vo['return_mode'] == 1): ?>
                    <input type="radio" name="return_mode" id="status-1" value="1" checked>
                    <?php else: ?>
                    <input type="radio" name="return_mode" id="status-1" value="1" >
                    <?php endif; ?>
                    <label for="status-1">按月返还</label>
                </div>
                <div class="radio-box">
                    <?php if($vo['return_mode'] == 2): ?>
                    <input type="radio" name="return_mode" id="status-1" value="2" checked>
                    <?php else: ?>
                    <input type="radio" name="return_mode" id="status-1" value="2" >
                    <?php endif; ?>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6 skin-minimal">
                <div class="radio-box">
                    ...
                    <?php else: ?>
                    <input type="radio" name="classify" id="status-1" value="1" >
                    <?php endif; ?>
                    <label for="status-1">常规分类</label>
                </div>
                <div class="radio-box">
                    <?php if($vo['classify'] == 2): ?>
                    <input type="radio" name="classify" id="status-1" value="2" checked>
                    <?php else: ?>
                    <input type="radio" name="classify" id="status-1" value="2" >
                    <?php endif; ?>
                    <label for="status-0">辅助分类</label>
                </div>
                <div class="radio-box">
                    <?php if($vo['classify'] == 3): ?>
                    <input type="radio" name="classify" id="status-1" value="3" checked>
                    <?php else: ?>
                    <input type="radio" name="classify" id="status-1" value="3" >
                    <?php endif; ?>
