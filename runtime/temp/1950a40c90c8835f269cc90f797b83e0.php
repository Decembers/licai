<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:65:"E:\GitHub\licai./application/admin\view\commodity\recyclebin.html";i:1512804941;s:64:"E:\GitHub\licai./application/admin\view\template\recyclebin.html";i:1512955060;s:58:"E:\GitHub\licai./application/admin\view\template\base.html";i:1488899632;s:69:"E:\GitHub\licai./application/admin\view\template\javascript_vars.html";i:1488899632;s:59:"E:\GitHub\licai./application/admin\view\commodity\form.html";i:1512976114;s:57:"E:\GitHub\licai./application/admin\view\commodity\th.html";i:1513328068;s:57:"E:\GitHub\licai./application/admin\view\commodity\td.html";i:1513328401;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <input type="text" class="input-text" style="width:250px" placeholder="商品id" name="id" value="<?php echo \think\Request::instance()->param('id'); ?>" >
    <input type="text" class="input-text" style="width:250px" placeholder="商品名称" name="name" value="<?php echo \think\Request::instance()->param('name'); ?>" >
...
<td><?php echo $vo['com_number']; ?></td>
<td><?php echo $vo['name']; ?></td>
<td><img src="<?php echo $vo['image']; ?>" width="80" height="80"></td>
<td><?php echo $vo['price']; ?></td>
<td><?php echo $vo['rate']; ?></td>
<!-- <td><?php echo $vo['content']; ?></td> -->
<td><?php echo $vo['number']; ?></td>
<td>
<?php if($vo['classify'] == 1): ?>
常规
